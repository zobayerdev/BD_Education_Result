...
public class HscActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("HSC Result");
        ...
        web.setWebViewClient(new HscActivity.pdweb(pd));
...
/*        web.getSettings().setAllowFileAccess(true);
        ...
        web.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                ...
                dm.enqueue( request );
                Toast.makeText ( HscActivity.this, "Downloading File", Toast.LENGTH_SHORT ).show();
            }
        });
