...
public class HscActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("এইচএসসি রেজাল্ট");


        // ###########################################################
        // locate your Web ID...
        webview = (WebView) findViewById(R.id.webHSC);
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(HscActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                    }
                } else {
    ...
    public void downloadDialog(final String url, final String userAgent, String contentDisposition, String mimetype) {
        ...
        //alertdialog
        AlertDialog.Builder builder = new AlertDialog.Builder(HscActivity.this);
