...
public class JscActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("JSC Result");
        ...
        web.setWebViewClient(new JscActivity.pdweb(pd));
...
/*        web.getSettings().setAllowFileAccess(true);
        ...
        web.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                ...
                dm.enqueue( request );
                Toast.makeText ( JscActivity.this, "Downloading File", Toast.LENGTH_SHORT ).show();
            }
        });
