...
public class MbbsActivity extends AppCompatActivity {
    ...
    private WebView web;
    String webUrl = "http://result.dghs.gov.bd/mbbs/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web.setWebViewClient(new MbbsActivity.pdweb(pd));
...
/*        web.getSettings().setAllowFileAccess(true);
        ...
        web.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                ...
                dm.enqueue( request );
                Toast.makeText ( MbbsActivity.this, "Downloading File", Toast.LENGTH_SHORT ).show();
            }
        });
