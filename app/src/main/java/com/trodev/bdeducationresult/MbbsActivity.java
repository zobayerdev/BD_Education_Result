...
public class MbbsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("MBBS Result");


        // ###########################################################
        // locate your Web ID...
        webview = (WebView) findViewById(R.id.webMBBS);

        // ###########################################################
        // WebSite Address Here
        // webview.loadUrl("http://180.211.137.51/ResultSingle.aspx");
        webview.loadUrl("http://result.dghs.gov.bd/mbbs/");
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(MbbsActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                    }
                } else {
    ...
    public void downloadDialog(final String url, final String userAgent, String contentDisposition, String mimetype) {
        ...
        //alertdialog
        AlertDialog.Builder builder = new AlertDialog.Builder(MbbsActivity.this);
