...
public class SscActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("SSC Result");
        ...
        web.setWebViewClient(new SscActivity.pdweb(pd));
...
/*        web.getSettings().setAllowFileAccess(true);
        ...
        web.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                ...
                dm.enqueue( request );
                Toast.makeText ( SscActivity.this, "Downloading File", Toast.LENGTH_SHORT ).show();
            }
        });
